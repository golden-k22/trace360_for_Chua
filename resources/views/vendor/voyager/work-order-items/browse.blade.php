@extends('voyager::work-orders.tab_layout')

@section('sub-content')
    <div class="container-fluid ">
        @if($po_create!=true)
            @can('add', app($dataType->model_name))
                <a href="{{ route('work-orders/{id}/work-order-items/create', $categoryId) }}"
        ...
        <a href="{{ route('voyager.work-orders.index') }}" class="btn btn-warning">
                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            @foreach($actions as $action)
                                                @if (!method_exists($action, 'massAction'))
                                                    ...
                                                    @if($action->getTitle()=="View")
                                                        @php
                                                            $id=$data->id;
                                                            $fr_wo_id=DB::table('work_orders')->where('id', $data->fr_wo_id )->pluck('description')->first();
                                                            $fr_rec_id=DB::table('recipes')->where('id', $data->fr_rec_id )->pluck('name')->first();
                                            ...
                                            <a
                                                    href="{{ url('admin/work-orders/'.$categoryId.'/production-orders/'.$data->id) }}"
                                                    title="Production" class="btn btn-sm btn-primary">
                                                <i class="voyager-list"></i> <span class="hidden-xs hidden-sm">View Production orders</span>
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" align="center"><b>View Work Order Item</b></h4>
                </div>
                    ...
                    <form role="form" action="/edit_user">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="modal-view-id" class="form-control" id="modal-view-id"
                                       value="ID" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="modal-view-woid">Work Order </label>
                                <input type="text" name="modal-view-woid" class="form-control" id="modal-view-woid"
                                       value="ID" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="modal-view-recid">Recipe </label>
                                <input type="text" name="modal-view-recid" class="form-control" id="modal-view-recid"
                                       value="ID" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="modal-view-batch">Number of Batch </label>
                                <input type="text" name="modal-view-batch" class="form-control" id="modal-view-batch"
                                       value="ID" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="modal-view-created">Created At </label>
                                <input type="text" name="modal-view-created" class="form-control"
                                       id="modal-view-created" value="ID" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="modal-view-updated">Updated At </label>
                                <input type="text" name="modal-view-updated" class="form-control"
                                       id="modal-view-updated" value="ID" readonly="readonly">
                            </div>
...
@section('javascript')
    ...
    <script>
        ...
        $('.view').on('click', function (e) {
            ...
            $('#modal-view-woid').val($(this).data('fr_wo_id'));
            $('#modal-view-recid').val($(this).data('fr_rec_id'));
            $('#modal-view-batch').val($(this).data('no_of_batch'));
        ...
        $(function () {
            $('#show_soft_deletes').change(function () {
                if ($(this).prop('checked')) {
                    $('#dataTable').before('<a id="redir" href="{{ (route('work-orders/{id}/work-order-items', array_merge($params, ['showSoftDeleted' => 1,$categoryId]), true)) }}"></a>');
                } else {
                    $('#dataTable').before('<a id="redir" href="{{ (route('work-orders/{id}/work-order-items', array_merge($params, ['showSoftDeleted' => 0,$categoryId]), true)) }}"></a>');
                }
